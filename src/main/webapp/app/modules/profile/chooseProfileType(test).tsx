...
const ChooseProfileType = () => {
  ...
  return (
    ...
    <Translate contentKey="ChooseProfileType.title">
    ...
    <Translate contentKey="ChooseProfileType.regular_user">
    ...
    <Translate contentKey="ChooseProfileType.Signup">

          Create a standard user account to browse doctors and services
    ...
    <h3>Doctor</h3>
    <p className="mb-4">
            <Translate contentKey="ChooseProfileType.DoctorSignup">

               Create a doctor profile to offer medical services

            </Translate>
    </p>
    <Button color="primary" onClick={() => handleRoleSelect(AUTHORITIES.DOCTOR)}>
         <Translate contentKey="ChooseProfileType.select">
